...
public class PropertiesDomo02 {
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		//使用相对路径,输出到当前工程
		pro.store(new FileOutputStream(new File("src/cn/zhang/fCollection/others/db.properties")), "db配置");
		pro.storeToXML(new FileOutputStream(new File("src/cn/zhang/fCollection/others/db.xml")), "db配置");
	}
}
